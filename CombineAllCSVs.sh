...
python CombineCSVs.py *_BannerPosts.csv CombinedCSVs/BannerPosts.csv
python CombineCSVs.py *_BorderTowers.csv CombinedCSVs/BorderTowers.csv
python CombineCSVs.py *_Bridges.csv CombinedCSVs/Bridges.csv
python CombineCSVs.py *_Guardtowers_Roadside.csv CombinedCSVs/Guardtowers_Roadside.csv
python CombineCSVs.py *_Locations.csv CombinedCSVs/Locations.csv
...
python CombineCSVs.py *_Mountains_Foothills.csv CombinedCSVs/Mountains_Foothills.csv
